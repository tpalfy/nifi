...
public class VersionedSNMPFactory
//    implements ClientSNMPFactory
{

    private static final String INVALID_SNMP_VERSION = "SNMP version is not supported.";
    private static final Map<Integer, ClientSNMPFactory> FACTORIES;

    static {
        final Map<Integer, ClientSNMPFactory> factories = new HashMap<>();
...
//        final ClientSNMPFactory factory = getMatchingFactory(configuration.getVersion());
...
//    }
    ...
    public static ClientSNMPFactory getMatchingFactory(final int version) {
