...
This displays the NiFi Settings window. The window has four tabs: General, Reporting Task/flow Analysis Rule Controller Services, Reporting Tasks and Registry Clients. The General tab provides settings for the overall maximum thread counts of the instance.
